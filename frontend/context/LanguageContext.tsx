...
const translations: Translations = {
    zh: {
        ...
        "proxy": "代理 (可选)",
        "proxy_placeholder": "socks5://ip:port 或 http://ip:port",
        ...
        "task_center": "任务中心",
        "task_center_desc": "配置一次任务内容，选择多个账号，并为每个账号设置不同触发时间。",
        "task_center_entry_hint": "批量创建同一任务",
        "template_account": "聊天列表来源账号",
        "template_account_hint": "只用于读取群/频道列表；实际创建到哪些账号，请在下方“同一任务的账号运行时间”中勾选。",
        "offset_rule": "批量错开账号运行时间",
        "selected_accounts": "个账号已选",
        "schedule_hint": "先设置基础时间和账号间隔，应用后仍可在下方逐账号微调。",
        "fixed_time": "固定时间",
        "stagger_minutes": "账号间隔 (分钟)",
        "apply_stagger": "应用到已选账号",
        "account_schedule": "同一任务的账号运行时间",
        "per_account_schedule": "在这里勾选要创建任务的账号，并逐个设置固定时间或随机时间段。",
        "select_all": "全选",
        "clear_selection": "清空选择",
        "task_center_no_accounts": "暂无可用账号，请先添加账号",
        "account": "账号",
        "mode": "模式",
        "trigger": "触发时间",
        "no_account_selected": "请至少选择一个账号",
        "fixed_time_required": "请填写固定触发时间",
        "create_batch_success": "已创建 {count} 个账号任务",
        "create_batch_partial": "创建完成：成功 {created} 个，失败 {failed} 个。{errors}",
        "basic_config": "基本配置",
        ...
        "account_package_import": "导入账号包",
        "account_package_export_telethon": "导出 Telethon",
        "account_package_export_tdata": "导出 TData",
        "account_package_zip": "账号 Zip 包",
        "account_package_supported": "支持的账号包格式",
        "account_package_supported_desc": "支持 Telegram-Panel 兼容的 Telethon 包（.json + .session + 可选 2fa.txt）和 TData 包（tdata 目录）。默认遇到已有账号会跳过。",
        "account_package_overwrite": "允许覆盖已有账号",
        "account_package_overwrite_desc": "开启后，同名账号的现有 session 会被替换；关闭时会跳过冲突账号。",
        "account_package_import_results": "导入结果",
        "account_package_import_done": "账号包导入完成",
        "account_package_import_failed": "账号包导入失败",
        "account_package_export_success": "账号包导出成功",
        "account_package_export_failed": "账号包导出失败",
        "account_package_skipped": "跳过",
    ...
    en: {
        ...
        "proxy_placeholder": "socks5://ip:port or http://ip:port",
        ...
        "task_center_desc": "Configure task content once, select multiple accounts, and set different trigger times for each account.",
        "task_center_entry_hint": "Batch create one task",
        "template_account": "Chat List Source",
        "template_account_hint": "Only used to load chats. Select target accounts in \"Per-Account Run Time\" below.",
        "offset_rule": "Stagger Account Run Times",
        "selected_accounts": "accounts selected",
        "schedule_hint": "Set a base time and account interval first, then fine-tune each account below.",
        "fixed_time": "Fixed Time",
        "stagger_minutes": "Account Interval (min)",
        "apply_stagger": "Apply to Selected",
        "account_schedule": "Per-Account Run Time",
        "per_account_schedule": "Select the accounts to create this task for, then set a fixed time or random range per account.",
        "select_all": "Select All",
        "clear_selection": "Clear",
        "task_center_no_accounts": "No accounts available. Add an account first.",
        "account": "Account",
        "mode": "Mode",
        "trigger": "Trigger",
        "no_account_selected": "Select at least one account",
        "fixed_time_required": "Please enter a fixed trigger time",
        "create_batch_success": "Created tasks for {count} accounts",
        "create_batch_partial": "Created {created}, failed {failed}. {errors}",
        ...
        "proxy_invalid": "Invalid proxy format, please check",
        ...
        "account_package_import": "Import Accounts",
        "account_package_export_telethon": "Export Telethon",
        "account_package_export_tdata": "Export TData",
        "account_package_zip": "Account Zip",
        "account_package_supported": "Supported account packages",
        "account_package_supported_desc": "Supports Telegram-Panel compatible Telethon packages (.json + .session + optional 2fa.txt) and TData packages (tdata directory). Existing accounts are skipped by default.",
        "account_package_overwrite": "Allow overwrite",
        "account_package_overwrite_desc": "When enabled, matching existing account sessions will be replaced; otherwise conflicts are skipped.",
        "account_package_import_results": "Import Results",
        "account_package_import_done": "Account package import completed",
        "account_package_import_failed": "Account package import failed",
        "account_package_export_success": "Account package exported",
        "account_package_export_failed": "Account package export failed",
        "account_package_skipped": "Skipped",
