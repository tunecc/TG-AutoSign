...
const translations: Translations = {
    zh: {
        ...
        "template_account_hint": "用于读取会话列表；任务创建时会按下方账号表逐个生成。",
        "offset_rule": "统一错峰规则",
        ...
        "account_schedule": "账号触发时间",
        "per_account_schedule": "勾选要创建任务的账号，并为每个账号设置固定时间或随机时间段。",
        "select_all": "全选",
    ...
    en: {
        ...
        "template_account": "Template Account",
        "template_account_hint": "Used to read the chat list; tasks are created per account from the schedule table below.",
        "offset_rule": "Stagger Rule",
        ...
        "account_schedule": "Account Trigger Times",
        "per_account_schedule": "Select accounts and set fixed time or random range for each one.",
